# Contributing to madcatter

Thanks for helping improve madcatter.

## Why this file exists

madcatter accepts public changes through a generated public repository while the source tree stays canonical. Contributors need to know how to validate changes locally and which branches are safe to edit.
...
uv run pytest
uv run python -c "import madcatter"
uv build
```
...
Do not edit generated `madcatter/export/*` branches directly.
